...
public class HOOQ_Web_Sanity_Home_Page_VerifyHomePage extends HOOQWorkflows{
		/*
		 * Verify Home Page Screen
		 */	 
	 
	ExcelReader xlsLogin = new ExcelReader(configProps.getProperty("WEB_TEST_DATA_SANITY"),"Home_01");
		@Test(dataProvider = "testData",groups={"web"})
		public  void HOOQ_Web_Sanity_Home_Page_VerifyHomePage (String email,String type,String userType,String description) throws Throwable {
			try{
