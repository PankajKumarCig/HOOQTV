...
public class HOOQ_Web_FaceBookLogin extends HOOQWorkflows{
		/*
	...
	ExcelReader xlsLogin = new ExcelReader(configProps.getProperty("WEB_TEST_DATA"),"C92");
		...
		public  void HOOQ_Web_FaceBookLogin (String email,String type,String userType,String description) throws Throwable {
		try
		{
