...
public class HOOQ_Web_Verify_WatchLater extends HOOQWorkflows{
		/*
		 * Verify Login functionality from My Account screen
		 */	 
	 
	ExcelReader xlsLogin = new ExcelReader(configProps.getProperty("WEB_TEST_DATA"),"WatchLater_01");
		@Test(dataProvider = "testData",groups={"web"})
		public  void HOOQ_Web_Verify_WatchLater (String email,String type,String userType,String description) throws Throwable {
			try{
		...
		public Object[][] createdata1() {
		    return (Object[][]) new Object[][] { 
	    		...
	    		{xlsLogin.getCellValue("IN_ACTIVE_USER", "Value"),"valid",xlsLogin.getCellValue("USER_TYPE_ACTIVE", "Value"),"Verifying HOOQ_Verify_WatchLaterHomePage scenarios for IN_ACTIVE_USER"},
		    };
		}
}
