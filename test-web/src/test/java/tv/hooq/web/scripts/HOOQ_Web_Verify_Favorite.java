...
public class HOOQ_Web_Verify_Favorite extends HOOQWorkflows{
		/*
	...
	ExcelReader xlsLogin = new ExcelReader(configProps.getProperty("WEB_TEST_DATA"),"Faviorite_01");
		...
		public  void HOOQ_Web_Verify_Favorite (String email,String type,String userType,String description) throws Throwable {
			try{
