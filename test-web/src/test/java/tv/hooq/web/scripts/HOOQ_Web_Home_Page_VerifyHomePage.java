...
public class HOOQ_Web_Home_Page_VerifyHomePage extends HOOQWorkflows{
		/*
	...
	ExcelReader xlsLogin = new ExcelReader(configProps.getProperty("WEB_TEST_DATA_SANITY"),"Home_01");
		...
		public  void HOOQ_Web_Home_Page_VerifyHomePage (String email,String type,String userType,String description) throws Throwable {
			try{
