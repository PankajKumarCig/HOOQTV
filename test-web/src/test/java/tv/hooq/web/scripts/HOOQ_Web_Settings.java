...
public class HOOQ_Web_Settings extends HOOQWorkflows{
		/*
		 * Verify Login functionality from My Account screen
		 */	 
	 
	ExcelReader xlsLogin = new ExcelReader(configProps.getProperty("WEB_TEST_DATA"),"Hooq_Setting");
		@Test(dataProvider = "testData",groups={"web"})
		public  void HOOQ_Web_Settings (String email,String type,String userType,String description) throws Throwable {
			try{
		...
		public Object[][] createdata1() {
		    return (Object[][]) new Object[][] { 
	    		...
	    		{xlsLogin.getCellValue("IN_ACTIVE_USER", "Value"),"valid",xlsLogin.getCellValue("USER_TYPE_ACTIVE", "Value"),"Verifying Hooq Settings scenarios for IN_ACTIVE_USER"},
	    		{xlsLogin.getCellValue("IN_LAPSED_USER", "Value"),"valid",xlsLogin.getCellValue("USER_TYPE_LAPSED", "Value"),"Verifying Hooq Settings scenarios for IN_LAPSED_USER"},
