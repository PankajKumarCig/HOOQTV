...
public class HOOQ_Web_TVOD_Rent_With_CC extends HOOQWorkflows {
	/*
...
ExcelReader xlsLogin = new ExcelReader(configProps.getProperty("WEB_TEST_DATA"),"TVOD_Rent");
	...
	public  void HOOQ_Web_TVOD_Rent_With_CC (String email,String type,String userType,String description,boolean blnTicketEnable) throws Throwable {
		try{
			...
			if(userType.equals("Anonymos"))
			{
				...
				//Click on Skip
					...
					fnRentMoviewithCC(userType,blnTicketEnable);
