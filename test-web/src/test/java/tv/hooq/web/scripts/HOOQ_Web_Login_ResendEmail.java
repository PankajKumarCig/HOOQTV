...
public class HOOQ_Web_Login_ResendEmail extends HOOQWorkflows{
		/*
	...
	ExcelReader xlsLogin = new ExcelReader(configProps.getProperty("WEB_TEST_DATA"),"C92");
		...
		public  void HOOQ_Web_Login_ResendEmail (String email,String type,String userType,String description) throws Throwable {
			try{
				
				TestEngine.testDescription.put(HtmlReportSupport.tc_name, description);
				//Verify Login with Resend Email
				verifyLoginWithResendEmail(email,type,userType);		
		...
		public Object[][] createdata1() {
		    return (Object[][]) new Object[][] { 
		    		{xlsLogin.getCellValue("IN_EXISTING_USER", "Value"),xlsLogin.getCellValue("VALID_TYPE", "Value"),xlsLogin.getCellValue("USER_TYPE_1", "Value"),"Verifying login scenarios Resend Email"},
		};
		}
}
