...
public class HOOQ_Web_Home_Page_VerifyBrowse extends HOOQWorkflows{
		/*
	...
	ExcelReader xlsLogin = new ExcelReader(configProps.getProperty("WEB_TEST_DATA"),"Home_02");
		...
		public  void HOOQ_Web_Home_Page_VerifyBrowse (String email,String type,String userType,String description) throws Throwable {
			try{
				...
				//Verify The Home Page Screen
					fnVerifyHomePageBrowseAfterLogin(type);	
				//Logout
