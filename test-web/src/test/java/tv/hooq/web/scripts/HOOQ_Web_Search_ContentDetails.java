...
public class HOOQ_Web_Search_ContentDetails extends HOOQWorkflows{
		/*
		 * Verify Login functionality from My Account screen
		 */	 
	 
	ExcelReader xlsLogin = new ExcelReader(configProps.getProperty("WEB_TEST_DATA"),"Search_01");
		@Test(dataProvider = "testData",groups={"web"})
		public  void HOOQ_Web_Search_ContentDetails (String email,String type,String userType,String description) throws Throwable {
			try{
		...
		public Object[][] createdata1() {
		    return (Object[][]) new Object[][] { 
	    		...
	    		{xlsLogin.getCellValue("IN_LAPSED_USER", "Value"),"valid",xlsLogin.getCellValue("USER_TYPE_LAPSED", "Value"),"Verifying Search and Content Details scenarios for IN_LAPSED_USER"},
	    		{xlsLogin.getCellValue("IN_ACTIVE_USER", "Value"),"valid",xlsLogin.getCellValue("USER_TYPE_ACTIVE", "Value"),"Verifying Search and Content Details scenarios for IN_ACTIVE_USER"},
